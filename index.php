	  ...
	  <div class="content-wrapper">
	    <div class="container">
	        		...
	        		<div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
		                ...
		                <div class="carousel-inner">
		                  <div class="item active">
		                    <img src="images/home1.jpg" height="100px" alt="First slide">
		                  </div>
		                  <div class="item">
		                    <img src="images/hom2.jpg" height="300px" alt="Second slide">
		                  </div>
		                  <div class="item">
		                    <img src="images/home3.jpg" height="300px" alt="Third slide">
		                  </div>
		                </div>
		  ...
		  <section class="content">
	        <div class="row">
	        	<div class="col-sm-9">
		            <h1 class="page-header"><?php echo 'Axions'; ?></h1>
		       		<?php
           $conn = $pdo->open();
           try {
               $inc = 3;
